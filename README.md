...
# Current limitations:
UI elements that are rotated or have the scale value different than 1 are not supported, size and position values may be wrong for those elements. I don't have more time to spend in this library but a PR to fix this is welcome.
